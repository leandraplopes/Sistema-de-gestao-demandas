[20:19, 08/08/2026] leandra p lopess: const btnNovaDemanda = document.getElementById("btnNovaDemanda");
...
[20:21, 08/08/2026] leandra p lopess: const btnNovaDemanda = document.getElementById("btnNovaDemanda");
const formulario = document.getElementById("formulario");
const btnSalvar = document.getElementById("btnSalvar");
const listaDemandas = document.getElementById("listaDemandas");
